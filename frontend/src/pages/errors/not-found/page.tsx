  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen text-center px-4 bg-background-50">
      ...
      <div className="relative z-10">
        <h1 className="text-xl md:text-2xl font-semibold mt-6 text-foreground-950">
          존재하지 않는 페이지입니다
        </h1>
        <p className="mt-2 text-base text-foreground-400 font-mono">
          {location.pathname}
        </p>
        <p className="mt-4 text-lg md:text-xl text-foreground-500">
          주소를 다시 확인해 주세요
        </p>
      </div>
    </div>
